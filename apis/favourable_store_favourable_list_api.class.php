...
class favourable_store_favourable_list_api extends Component_Event_Api {
    ...
    public function call(&$options) {
    	...
    	if (empty($favourable_list)) {
    		$favourable_list = $db_favourable->where(array('store_id' => $options['store_id'], 'start_time' => array('elt' => RC_Time::gmtime()), 'end_time' => array('egt' => RC_Time::gmtime()), 'act_type' => array('neq' => 0)))->select();
